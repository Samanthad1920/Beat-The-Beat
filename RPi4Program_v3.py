...
Version 3 (threads pls pls pls pls pls pls pls WORK)
...
#         led_activated = song_char_table.loc[index, 'LED Activated']
#         
#         if session_time >= beat_leadup and beat_pad == 2 and not led_activated:
#             leadUpLED()
#             beatLED()
#             song_char_table.at[index, 'LED Activated'] = True
#             args_dict["index"] = index + 1
#             update_event.set() 
#             update_event.clear()
#             
#         time.sleep(.001)
...
#     """Thread that controls left LED strip."""
#     global args_dict
#     while True:
#         update_event.wait()
#         
...
#         led_activated = song_char_table.loc[index, 'LED Activated']
#         
#         if session_time >= beat_leadup and beat_pad == 3 and not led_activated:
#             leadUpLED()
#             beatLED()
#             song_char_table.at[index, 'LED Activated'] = True
#             args_dict["index"] = index + 1
...
#         led_activated = song_char_table.loc[index, 'LED Activated']
#         
#         if session_time >= beat_leadup and beat_pad == 1 and not led_activated:
#             leadUpLED()
#             beatLED()
#             song_char_table.at[index, 'LED Activated'] = True
#             args_dict["index"] = index + 1
