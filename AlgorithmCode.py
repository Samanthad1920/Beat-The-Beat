# -*- coding: utf-8 -*-
"""Excursion 1 - Algorithm Code.ipynb
...
pathToImport = "test.mp3" # Import as .wav or .mp3
...
for index, timing in enumerate(beatMap):
  if timing <= 1.0:
    atwBefore[index] = 0.75*timing
    atwAfter[index] = atwBefore[index] + 1.0
    ptwBefore[index] = 0.90*timing
    ptwAfter[index] = ptwBefore[index] + 0.5
    beatLeadUp[index] = 0.0
  elif timing > 1.0:
    atwBefore[index] = timing - 0.33333
    atwAfter[index] = timing + 0.66667
    ptwBefore[index] = timing - 0.16667
    ptwAfter[index] = timing + 0.33333
    beatLeadUp[index] = timing - 1.0
